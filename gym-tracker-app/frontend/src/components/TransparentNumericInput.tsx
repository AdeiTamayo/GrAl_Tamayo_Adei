    ...
    return (
        <div className={`relative flex items-center group ${className}`}>
            ...
            <input
                ...
                className={`w-full bg-transparent border border-subtle rounded-lg focus:border-accent focus:outline-none transition-all [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none disabled:opacity-50 ${inputClassName}`}
            />
            ...
            <div className="absolute right-1 top-1/2 -translate-y-1/2 flex flex-col justify-center gap-0.5 opacity-30 group-hover:opacity-100 transition-opacity pointer-events-auto">
                <button
                    ...
                    className="text-[7px] text-dim hover:text-accent p-0.4 leading-none focus:outline-none select-none"
                    title="Increase"
                >
                    ▲
                </button>

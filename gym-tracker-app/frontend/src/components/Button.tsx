...
const Button: React.FC<ButtonProps> = ({
    ...
    switch (variant) {
        case 'primary':
            ...
            break;
        case 'secondary':
            variantStyles = 'rounded-xl px-4 py-2 bg-elevated hover:bg-hover text-body font-bold border border-subtle text-sm';
            break;
        case 'danger':
            variantStyles = 'rounded-xl px-4 py-2 bg-rose-500/10 hover:bg-rose-500 text-rose-500 hover:text-white font-bold border border-rose-500/20 text-sm';
            break;
    }

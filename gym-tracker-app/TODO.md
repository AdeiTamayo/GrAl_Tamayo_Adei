...
- [X] 2.2. Erabiltzailearen ezaugarriak: metrikak eta marka pertsonalak.
- [X] 2.3. Entrenamenduaren ezaugarriak: data, ariketa zerrenda, pisuak, errepikapenak eta serieak.
...
- [X] 4.1.1. Erabiltzaileei datuak eskuz sartzeko aukera eskaintzea: pisua, errepikapenak, serieak eta oharrak.
...
- [X] 5.1. **Proiektuaren plangintza:** Eskakizunak identifikatu, atazen banaketa finkatu eta hasierako plangintza dokumentua.

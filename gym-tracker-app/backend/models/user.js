...
//             const query = "INSERT INTO users (name, surname, email, password, gender, weight, height, birth_date, profile_picture) VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id";
//             const result = await pool.query(query, [name ?? null, surname ?? null, email, hashedPassword, gender ?? null, weight ?? null, height ?? null, birth_date ?? null, profile_picture ?? null]);
